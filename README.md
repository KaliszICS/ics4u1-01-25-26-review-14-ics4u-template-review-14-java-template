# Instructions  
  ...
  3. Create a function called _minString_ which takes in 3 Strings as parameters.  Output the String that comes in the earliest alphabetically (casing does not matter)
